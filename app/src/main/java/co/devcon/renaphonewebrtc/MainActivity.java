package co.devcon.renaphonewebrtc;
...
public class MainActivity extends AppCompatActivity implements RCDeviceListener, RCConnectionListener, ServiceConnection, View.OnClickListener {
    ...
    public void onClick(View view)
    {
        if (view.getId() == R.id.button_dial) {
            ...
            connectParams.put("username", "sip:alice@rena.devcon.co");
